...
mapwork.worker = {
    Init: function () {
        "use strict";
        mapwork.worker.compressionWorker = new Worker('Scripts/mapwork.worker.compression.js');
        mapwork.worker.BindEvent();
    },
    BindEvent: function () {
        "use strict";
        mapwork.worker.compressionWorker.onmessage = mapwork.worker.compressionWorker_ReceiveMessage;
    },
